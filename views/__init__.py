...
from .customers_request import get_all_customers, get_single_customer, get_customers_by_email
from .customers_request import create_customer, delete_customer, update_customer
